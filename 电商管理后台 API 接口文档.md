...
- [1. 电商管理后台 API 接口文档](#1-电商管理后台-api-接口文档)
    ...
    - [1.3. 用户管理](#13-用户管理)
        - [1.3.1. 用户数据列表](#131-用户数据列表)
        - [1.3.2. 添加用户](#132-添加用户)
        - [1.3.3. 修改用户状态](#133-修改用户状态)
        - [1.3.4. 根据 ID 查询用户信息](#134-根据-id-查询用户信息)
        - [1.3.5. 编辑用户提交](#135-编辑用户提交)
        - [1.3.6. 删除单个用户](#136-删除单个用户)
        - [1.3.7. 分配用户角色](#137-分配用户角色)
    - [1.4. 权限管理](#14-权限管理)
        - [1.4.1. 所有权限列表](#141-所有权限列表)
        - [1.4.2. 左侧菜单权限](#142-左侧菜单权限)
    - [1.5. 角色管理](#15-角色管理)
        - [1.5.1. 角色列表](#151-角色列表)
        - [1.5.2. 添加角色](#152-添加角色)
        - [1.5.3. 根据 ID 查询角色](#153-根据-id-查询角色)
        - [1.5.4. 编辑提交角色](#154-编辑提交角色)
        - [1.5.5. 删除角色](#155-删除角色)
        - [1.5.6. 角色授权](#156-角色授权)
        - [1.5.7. 删除角色指定权限](#157-删除角色指定权限)
    - [1.6. 商品分类管理](#16-商品分类管理)
        - [1.6.1. 商品分类数据列表](#161-商品分类数据列表)
        - [1.6.2. 添加分类](#162-添加分类)
        - [1.6.3. 根据 id 查询分类](#163-根据-id-查询分类)
        - [1.6.4. 编辑提交分类](#164-编辑提交分类)
        - [1.6.5. 删除分类](#165-删除分类)
    - [1.7. 分类参数管理](#17-分类参数管理)
        - [1.7.1. 参数列表](#171-参数列表)
        - [1.7.2. 添加动态参数或者静态属性](#172-添加动态参数或者静态属性)
        - [1.7.3. 删除参数](#173-删除参数)
        - [1.7.4. 根据 ID 查询参数](#174-根据-id-查询参数)
        - [1.7.5. 编辑提交参数](#175-编辑提交参数)
    - [1.8. 商品管理](#18-商品管理)
        - [1.8.1. 商品列表数据](#181-商品列表数据)
        - [1.8.2. 添加商品](#182-添加商品)
        - [1.8.3. 根据 ID 查询商品](#183-根据-id-查询商品)
        - [1.8.4. 编辑提交商品](#184-编辑提交商品)
        - [1.8.5. 删除商品](#185-删除商品)
    - [1.9. 图片上传](#19-图片上传)
    - [1.10. 订单管理](#110-订单管理)
        - [1.10.1. 订单数据列表](#1101-订单数据列表)
        - [1.10.2. 修改订单状态](#1102-修改订单状态)
        - [1.10.3. 查看订单详情](#1103-查看订单详情)
        - [1.10.4. 修改地址](#1104-修改地址)
        - [1.10.5. 查看物流信息](#1105-查看物流信息)
    - [1.11. 数据统计](#111-数据统计)
        - [1.11.1. 基于时间统计的折线图](#1111-基于时间统计的折线图)
